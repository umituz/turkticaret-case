...
/**
 * Unit tests for LanguageListRequest
 * Tests validation rules and authorization logic for language listing
 */
#[CoversClass(LanguageListRequest::class)]
#[Group('unit')]
#[Group('requests')]
#[Small]
class LanguageListRequestTest extends UnitTestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new LanguageListRequest();
    }
